...
RUN pip install celery==4.1.1 passlib[bcrypt] tenacity requests pydantic couchbase emails fastapi>=0.1.13 uvicorn gunicorn pyjwt python-multipart email_validator
