...
RUN pip install celery==4.1.1 passlib[bcrypt] tenacity requests pydantic couchbase emails fastapi uvicorn gunicorn pyjwt python-multipart email_validator
